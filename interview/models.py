...
class Candidate(models.Model):   #候选人类
    # 基础信息
    ...
    first_interviewer_user = models.ForeignKey(User, related_name='first_interviewer_user', blank=True, null=True, on_delete=models.CASCADE, verbose_name=u'面试官') #w外键引用
